...
import com.paf.proj.database.DbConnection;
import com.paf.proj.models.AddToCard;
import com.paf.proj.models.Item;
...
public class AddToCardDao {
	...
	public boolean addItemToCard(AddToCard addToCard) {
		...
		try {
			...
			//sql = "INSERT INTO add_to_card (item_id,userId,quantity) VALUES (?,?,?)";
